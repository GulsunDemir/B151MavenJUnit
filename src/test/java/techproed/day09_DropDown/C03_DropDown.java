...
/* 2.YOL
        List<WebElement> tumOption = driver.findElements(By.xpath("//select[@name='Languages']//option"));

        tumOption.stream().forEach(t-> System.out.println(t.getText()));
*/
        System.out.println("**********************************");

        //Sayfadaki tum Dropdown'lardaki tum optionlari konsolda yazdiriniz.
        ...
        //for ile yazdıralim
        for (WebElement w : tumDropDownTumOptionlar){
            System.out.println(w.getText());
        }
    }
