...
Dropdown'u handle(outomate) etmek icin
    1-Dropdown menu ilk olarak locate ederiz
    2-Select objesi olustururuz
    3-Select objesinin dropdown menu webelement'inin icerigine ve seceneklerine erisim saglamasi icin
...
WebDriver driver;
    ...
    public void test01() {
        ...
        select1.selectByValue("6");//July -> Option tag'ındaki value degerini aldik
    ...
    public void test02() {
        ...
        //getOptions() ile tum secenekleri yazdirdik
