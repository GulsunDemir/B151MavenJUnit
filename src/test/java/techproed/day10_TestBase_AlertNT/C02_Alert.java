 ...
 */
    ...
    public void acceptAlert() {
        ...
        WebElement resulMessage = driver.findElement(By.xpath("(//p)[2]"));
        String istenenYazi ="You successfully clicked an alert";
        Assert.assertEquals(istenenYazi,resulMessage.getText());
    ...
    public void dismissAlert() {
        ...
        Assert.assertFalse(resulMessage.getText().contains(istenenYazi));
        bekle(2);
    }
    @Test
    public void sendKeysAlert() {
        ...
        driver.switchTo().alert().sendKeys("Gül");
        ...
        WebElement resultMessage = driver.findElement(By.xpath("(//p)[2]")); //You entered: Gül
        String girilenMetin = "Gül";
