...
public class C01_TumSayfaResmi extends TestBase {
    ...
    public void test01() throws IOException {
        ...
        -Ikinci olarak TakeScreenShot arayuzunden obje olustururuz
        -Ucuncu olarak FileUtils class'indan copyFile() methodu ile ts objemizi kullanarak getScreenShotAs() metodu ile
